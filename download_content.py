...
def get_links(tiktok_url: str) -> list[str]:
...
def get_images_and_sound(links: list[str], id: str) -> None:
    images = links[0]
    sound = links[1]
    headers = {
        "User-Agent": "Mozilla/5.0",
...
def convert_images(id: str) -> None:
...
def download(tiktok_url: str, id: str) -> None:
